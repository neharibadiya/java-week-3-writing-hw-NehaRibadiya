...
public class Programme_5_SalarySlip {
    public static void main(String[] args) {
        ...
        double basicSlary = scanner.nextDouble();

        //calculating HRA, DA, TA, and PF
        double hRA = calculateHRA(basicSlary);
        double da = calculateDA(basicSlary);
        double Ta = calculateTA(basicSlary);
        double pf = calculatePF(basicSlary);

        // Calculating the gross salary
        double grossSalary = basicSlary + hRA + da + Ta - pf;
        ...
        System.out.println("|-------------------------------------|");
        System.out.println("|Basic Salary: " + basicSlary + "                |");
